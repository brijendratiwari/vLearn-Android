...
public class CustomTextViewTTF extends TextView {
    ...
    public CustomTextViewTTF(Context context, AttributeSet attrs) {
        super(context, attrs);
       ...
       // for (int i = 0; i < attrs.getAttributeCount(); i++) {
            ...
            this.ttfName = attrs.getAttributeValue(
                    "http://schemas.android.com/apk/res/com.vlearn.android", "customttf");
            if(ttfName != null)
            	init();
