...
public class CustomCheckedTextViewTTF extends CheckedTextView {
    ...
    public CustomCheckedTextViewTTF(Context context, AttributeSet attrs) {
        super(context, attrs);
       ...
       // for (int i = 0; i < attrs.getAttributeCount(); i++) {
            ...
            this.ttfName = attrs.getAttributeValue(
                    "http://schemas.android.com/apk/res/com.vlearn.android", "customCheckedttf");
            if(ttfName != null)
            	init();
